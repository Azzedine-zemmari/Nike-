<template>
    <div class="flex  space-x-96 md:space-x-72  lg:space-x-96 ">
        <svg class=" mt-7  ml-2 absolute top-2 left-4 sm:ml-0 lg:ml-10 md:ml-4" width="129" height="29" viewBox="0 0 129 29" fill="none" xmlns="http://www.w3.org/2000/svg">
...
21 -2447 2 c-2019 2 -2452 0 -2477 -11z"/>
    ...
    <div  v-if="show" class=" bg-stone-50 bg-opacity-50 shadow-sm rounded-md  w-fit px-4 py-4 space-y-1 absolute  top-10 right-5 font-Montserrat md:hidden lg:hidden">
